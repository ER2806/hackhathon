...
def calc(data):
	...
	0x4400,0x84C1,0x8581,0x4540,0x8701,0x47C0,0x4680,0x8641,0x8201,0x42C0,0x4380,0x8341,0x4100,0x81C1,0x8081,0x4040
        ...
        # print "crc high, low: " + str(crc_hi) + " " + str(crc_lo)
        return crc
	   	...
	   	if headerfirstbyte == 1 and headersecondbyte == 28 and headerthirtbyte == 32:
	    		...
	    		if int(size[0]) == 512: #Проверка размеров данных
	    			...
	    			if int(crc[0]) == crc_check: #Сравнения CRC
						...
						print learnData
                                                pockets.append(learnData) 
                                                frequency_amp_arr = signal_handler.parse_pocket(learnData, len(pockets));
                                                print "\n\n\n\n\nfreq arr:"
                                                print frequency_amp_arr
                                                print "__________________"
						counter = 0
